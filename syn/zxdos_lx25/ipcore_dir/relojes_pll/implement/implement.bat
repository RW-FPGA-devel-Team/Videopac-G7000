...
xst -ifn xst.scr
move relojes_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\relojes_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc relojes_pll_exdes.ucf relojes_pll_exdes

echo 'Running map'
map -timing -pr b relojes_pll_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm relojes_pll_exdes -w routed.ncd routed.v
cd ..
